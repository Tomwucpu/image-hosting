...
function createImageRecord(filename, width, height, sizeBytes) {
...
function normalizeImageEntry(entry, index) {
  if (typeof entry === "string") {
    return createImageRecord(entry, null, null, null);
  }
  ...
  return createImageRecord(filename, width, height, sizeBytes);
}
...
export function toApiImageSummary(image, absoluteUrl) {
  return {
    filename: image.filename,
    url: absoluteUrl,
